...
In the previous section, we saw that we could use a decision tree classifier to predict the species of a penguin from its beak measurements. This is sometimes called **symbolic AI** because the computer follows explicit rules that humans can read and understand.
